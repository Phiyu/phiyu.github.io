...
$$
	\langle \delta(\mathbf{k}_1)\delta(\mathbf{k}_2)\rangle_c =(2\pi)^3 P(k_1)\delta^D(\mathbf{k}_{12}),
$$
$$
	\langle \delta(\mathbf{k}_1)\delta(\mathbf{k}_2)\delta(\mathbf{k}_3)\rangle_c = (2\pi)^3\delta^D(\mathbf{k}_{123})B(k_1,k_2,k_3),
$$
$$
	\langle \delta(\mathbf{k}_1)\delta(\mathbf{k}_2)\delta(\mathbf{k}_3)\delta(\mathbf{k}_4)\rangle_c = (2\pi)^3\delta^D(\mathbf{k}_{1234})T(k_1,k_2,k_3,k_4).
$$
$$
	\left\langle \prod_i^n\delta(\mathbf{k}_i) \right\rangle_c = (2\pi)^3 \delta^D(\mathbf{k}_{12\dots n}) C_n(k_1,k_2,\dots,k_n)
$$
...
$$
	(2\pi)^3\delta^D(\mathbf{k}_{12\dots n}) = \int_{\mathbf{r}}\mathrm{e}^{-\mathrm{i}\mathbf{k}_{12\dots n}\cdot\mathbf{r}} = \int_{\mathbf{r}}\prod_i^n\mathrm{e}^{-\mathrm{i}\mathbf{k}_i\cdot\mathbf{r}} =\int_{\mathbf{r}}\prod_i^n 4\pi \sum_{\ell =0}^\infty \sum_{m=-\ell}^\ell (-\mathrm{i})^{\ell}Y_{\ell m}(\hat{k}_i) j_{\ell}(k_ir)Y^*_{\ell m}(\hat{r}).
$$
...
$$
	\langle \kappa_{1, \ell m}\kappa_{2,\ell' m'} \rangle = (4\pi)^2\mathrm{i}^{\ell+\ell'}\int_{\chi'}\int_{\chi''}\int_{\mathbf{k}_1}\int_{\mathbf{k}_2}W_1(\chi')W_2(\chi'')j_{\ell}(k_1\chi')j_{\ell'} (k_2 \chi'')Y_{\ell m}(\hat{k}_1)Y_{\ell' m'}(\hat{k}_2)\langle \delta(\mathbf{k}_1)\delta(\mathbf{k}_2)\rangle.
$$
Substituting the definition of power spectrum and expansion of Dirac delta, we can obtain
$$
	C_{\kappa_1 \kappa_2} = \langle \kappa_{1, \ell m}\kappa_{2,\ell' m'} \rangle  = \dfrac{2}{\pi} \int_{\chi'}\int_{\chi''} W_1(\chi')W_2(\chi'')\int k^2\mathrm{d}k\, j_{\ell}(k\chi')j_{\ell}(k\chi'') P(k,\chi',\chi'').
$$
### 3-point Correlator
...
$$
	\langle \kappa_{1,\ell_1m_1}\kappa_{2,\ell_2m_2}\kappa_{3,\ell_3m_3}\rangle = \dfrac{8}{\pi^3} \mathcal{G}_{m_1m_2m_3}^{\ell_1\ell_2\ell_3} \int r^2\mathrm{d}r\, \left[\prod_{i}^3\int_{\chi_i}\int k_i^2\mathrm{d}k_i\, W_i(\chi_i)j_{\ell_i}(k_i\chi_i)j_{\ell_i}(k_ir) \right]B(k_1,k_2,k_3).
$$
...
$$
	\left[\prod_i^44\pi\mathrm{i}^{\ell_i}\int_{\chi_i}\int_{\mathbf{k}_i} W_i(\chi_i)j_{\ell_i}(k_i\chi_i)Y_{\ell_im_i}(\hat{k}_i) \right]\langle \delta_1 \delta_2 \rangle \langle \delta_3 \delta_4 \rangle = (-1)^{m_1+m_3} \delta^K_{\ell_1\ell_2}\delta^K_{m_1,-m_2}\delta^K_{\ell_3\ell_4}\delta^K_{m_3,-m_4} C_{\kappa_1\kappa_2}C_{\kappa_3\kappa_4}\equiv D_{12|34}.
$$
For the connected correaltor, we give a general expression
$$
	\left\langle \prod_{i}^n \kappa_{i, \ell_i m_i} \right\rangle_c = \left[\prod_i^n4\pi\mathrm{i}^{\ell_i}\int_{\chi_i}\int_{\mathbf{k}_i} W_i(\chi_i)j_{\ell_i}(k_i\chi_i)Y_{\ell_im_i}(\hat{k}_i) \right]\left\langle \prod_i^n\delta(\mathbf{k}_i) \right\rangle_c.
$$
...
$$
	\boxed{
	\left\langle \prod_{i}^n \kappa_{i, \ell_i m_i} \right\rangle_c = \left(\dfrac{2}{\pi}\right)^n \mathcal{I}_{m_1m_2\dots m_n}^{\ell_1\ell_2\dots ell_n} \int r^2\mathrm{d}r\, \left[\prod_{i}^n\int_{\chi_i}\int k_i^2\mathrm{d}k_i\, W_i(\chi_i)j_{\ell_i}(k_i\chi_i)j_{\ell_i}(k_ir) \right]C_n(k_1,k_2,\dots,k_n).
	}
$$
